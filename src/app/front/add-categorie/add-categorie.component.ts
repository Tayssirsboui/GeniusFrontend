...
export class AddCategorieComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<AddCategorieComponent>, // Référence à la boîte de dialogue (Material)
  ...
  onSubmit(): void {
    ...
    if (this.isEditMode && this.data?.idCategorie) {
      this.categorieService.updateCategory(this.data.idCategorie, formData).subscribe({
        next: () => this.dialogRef.close(true), // Ferme le dialogue en cas de succès
